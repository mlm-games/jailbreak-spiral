...
const LEVELS : Dictionary = {1: "Prisoner", 2: "Basic Guard", 3: "Baton Guard", 4: "Pistol Guard", 5: "SMG Guard"}
...
func modify_stat(stat_key: Stats, operation: Operation, value: float) -> void:
	...
	match operation:
		...
		#World.player.health_component.heal_or_damage(value)
	#elif stat_key == Stats.PLAYER_MAX_HEALTH:
	World.player.update_max_health(stat.current_value)
